...
def get_version():
    """Get current version of dvid

    Returns:
        Str -- Returns current version of application
    """
    from dvid import __version__
...
# SOURCE: https://github.com/iamprofessorex/pocketsphinx-build/blob/master/pocketsphinx_build/build.py
